...
const LAYERS: StackLayer[] = [
  {
    ...
    icon: Brain,
    ttUsing: "bedrock.anthropic.claude-opus-4-8 (primary) · sonnet-4-6 (fast)",
    ttDetail: "Tier-routed via core/model_router: Opus 4-8 (newest/largest frontier Claude) for TC generation, coverage verification, and decomposition; Sonnet 4-6 for chat, navigation, and extraction; Haiku 4-5 as the fast/fallback tier. All served via the GenAI LiteLLM proxy.",
    statusKey: "llm",
    tools: [
      { name: "bedrock.anthropic.claude-opus-4-8", active: true },
  ...
  },
  {
    ...
    icon: Network,
    ttUsing: "azure.text-embedding-3-large (3072-dim)",
    ttDetail: "Highest-fidelity embeddings via the GenAI proxy /embeddings endpoint using the full 3072 dimensions of text-embedding-3-large. Used for KB indexing and similarity search. Changing the model/dim auto-triggers a one-time re-index.",
    statusKey: "embed",
    tools: [
      { name: "azure.text-embedding-3-large", active: true },
